...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, firebaseToken: $firebaseToken, birthDate: $birthDate, gender: $gender, genderId: $genderId, province: $province, provinceId: $provinceId, imgUrl: $imgUrl)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, firebaseToken,
      birthDate, gender, genderId, province, provinceId, imgUrl);
...
abstract class _User extends User {
  const factory _User(
      ...
      final String? province,
      final String? provinceId,
      final String? imgUrl}) = _$UserImpl;
